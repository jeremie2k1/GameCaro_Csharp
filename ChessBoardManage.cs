...
namespace GameCaro
{
    public class ChessBoardManage
    {
        ...
        private event EventHandler<ButtonClickEvent> playerMarked; // Xem lại phần Event
        ...
        public void btn_Click(object sender, EventArgs e)
        {
            ...
            PlayTimeLine.Push(new PlayerInfo(GetChessPoint(button), CurrentPlayer));
            ...
            if (playerMark != null)
            {
                playerMarked(this, new ButtonClickEvent(GetChessPoint(button))); // đưa event lên Form1
            } 
            // Nếu để thì 2 thằng cứ gửi event qua lại cho nhau => không cần
        ...
        public void OtherPlayerMark(Point point)
        {
            ...
            // Xử lý thô: enable  *** Tối ưu sau
            //chessBoard.Enabled = true; ***    đẩy xuống phần lắng nghe dữ liệu
        ...
        public bool Undo()
        {
            ...
            PlayerInfo oldPoint = PlayTimeLine.Peek();
            CurrentPlayer = oldPoint.CurrentPlayer == 1 ? 1 : 0;
        ...
        {
            //if (count >= 2) progressBar.Value = 0;
            if (PlayTimeLine.Count <= 0)
                return false;
            ...
            {
                oldPoint = PlayTimeLine.Peek(); //Lấy đối tượng cuối cùng trong stack để XEM chứ không lấy luôn như .POP()
    ...
    //Tạo một Paramater event // event cấp độ 2
